...
def NaICrossCorrelationPulseFinder( data ):
    ...
    trigger_position = 500 # sample number of trigger within waveform
    cc_window = 250 # number of samples on either side of trigger to include in cross-correlation
    cut_window = 75 # number of samples on either side of trigger to search for pulses
